...
gerencial das corporações.  Experimentos realizados
em \citeonline{gombolay2015decision} com times híbridos de humanos e robôs, em
ambiente controlado simulando uma linha de produção, verificaram o impacto da
introdução de elementos automáticos na distribuição e coordenação do trabalho.
Os resultados, apresentados na Figura~\ref{graficoMIT}, mostram que a automação
da distribuição do trabalho trouxe ganhos de eficiência operacional e, mais
acentuadamente, gerencial, resultante da tomada de decisões melhores e em menor
tempo.
...
A metodologia do trabalho será baseada no modelo de três ciclos para pesquisa
...
\paragraph{Ciclo de Relevância} O ponto de vista Contexto é a descrição das
...
projeto baseado exatamente no impacto que terão no domínio, a modelagem do
ponto de vista Contexto foi considerada como o resultado da execução do ciclo
de relevância.

\paragraph{Ciclo de Rigor} Dado que são objetivos do ciclo de rigor trazer da
...
\paragraph{Ciclo de Projeto} O ciclo de projeto, constituído da modelagem,
