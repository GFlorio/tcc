...
projeto. As características de cada módulo estão apresentados na
Figura~\ref{nist}.

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{nist}
	\caption{Características do processamento e transmissão de dados nos módulos.\label{nist}}
\end{figure}
...
de dados unificado. A estrutura lógica de cada um está definida em
...
\begin{figure}[h]
	...
	\caption{Diagrama de Entidade-Relacionamento em nível de implementação do módulo Modelagem.\label{ermod}}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{ermed}
	\caption{Diagrama de Entidade-Relacionamento em nível de implementação do módulo Medição.\label{ermed}}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{eraloc}
	\caption{Diagrama de Entidade-Relacionamento em nível de implementação do subsistema de Gestão Estratégica.\label{eraloc}}
\end{figure}
