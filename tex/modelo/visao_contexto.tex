...
alocação de recursos às tarefas, fornecendo boas sugestões de planos de
alocação para atender às necessidades da operação.
...
Os resultados citados, em geral, são armazenados em algum tipo de sistema
de informação para apoio operacional, o que pode significar de uma planilha
eletrônica até um sistema completo de ERP\@. Esses dados precisam ser
informados para que possam ser agregados em indicadores para o gestor
...
sistema, enquanto a Figura~\ref{casosop} e a Figura~\ref{casosest} apresentam
os diagramas de caso de uso para os dois subsistemas descritos.

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{casosop}
	\caption{Diagrama de casos de uso do subsistema operacional.\label{casosop}}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{casosest}
...
atualizado e sincronizado entre os subsistemas cria a necessidade de alguns casos de uso adicionais, ativados periodicamente.
