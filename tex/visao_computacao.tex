...
\begin{figure}[t]
	...
	\caption{Diagrama de domínio da aplicação.}
	\label{dominio}
\end{figure}
...
\begin{figure}[t]
	...
	\caption{Divisão dos módulos do sistema em camadas corporativas.}
	\label{corporativas}
\end{figure}
...
\begin{figure}[t]
	...
	\caption{Arquitetura em camadas do módulo Alocação.}
	\label{camadas_alocacao}
\end{figure}
...
\begin{figure}[t]
	...
	\caption{Arquitetura em camadas do módulo Medição.}
	\label{camadas_medicao}
\end{figure}
...
\begin{figure}[t]
	...
	\caption{Arquitetura em camadas do módulo Comunicação.}
	\label{camadas_comunicacao}
\end{figure}
...
\begin{figure}[t]
	...
	\caption{Arquitetura em camadas do módulo Simulação.}
	\label{camadas_simulacao}
\end{figure}
...
\begin{figure}[t]
	...
	\caption{Arquitetura em camadas do módulo Gestão da Alocação.}
	\label{camadas_gestao_alocacao}
\end{figure}
...
\begin{figure}[t]
	...
	\caption{Protótipo da tela principal da aplicação de validação do sistema.}
	\label{tela_operacional}
\end{figure}
\clearpage
