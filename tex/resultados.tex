...
avaliar: a manutenção mecânica de fornos elétricos de das áreas da fábrica. Um
exemplo ilustrativo da estrutura do banco de dados estrutura encontra-se na
...
determinação $r^2~=~0.87$, considerável aceitável para o uso em planejamento.
